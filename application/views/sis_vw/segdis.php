...
<div class="row bolding">
  <div class="col l2 m2 s2 center-align"></div>
  <div class="col l4 m4 s8 center-align">Distrito: <?=$dis->distrito?></div>
  <div class="col l4 m4 s8 center-align">Departamento: <?=$dis->departamento?></div>
  <div class="col l2 m2 s2 center-align"></div>
</div>
    <div class="table-responsive">
        <table id="table_dist" class="table tabla centered">
            <tr class="enc">
                <td rowspan="2">Nro.</td><td rowspan="2">SIE</td><td  rowspan="2">Unidad Educativa</td><td  rowspan="2">Maestros</td><td  rowspan="2">Reportes</td>
            ...
            foreach ($res as $key => $value) {
                ...
                if($resultado<50)
                    ...
                    if($resultado<70)
                        ...
                        $color = "verde";
                echo "<tr>";
                echo "<td>".$i."</td><td>$value->cod_ue</td><td>$value->ue</td><td>$value->maestros</td><td class='bolding ". $color ."'>$value->reporte</td>";
    ...
    <div class="row">
        ...
        <div class="col l4 m4 s12 center-align">
            <a href="<?=base_url().'reportsup/printdis'?>" class="btn orange darken-3">Imprimir Reporte</a>
        </div>
    </div>
